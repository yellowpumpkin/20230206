                                    ...
                                    <table id="myTable" class="display" style="width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="btn btn-secondary"><?php echo $row["status_name"]; ?></a></td>
                                                <?php } ?>
                                                <?php
                                                ...
                                                <td><a class="btn btn-primary"><?php echo $row["status_name"]; ?></a>
                                                </td>
                                                <?php } ?>
                                                <?php
                                                            if ($row["status_name"] == $status[4]){ ?>
                                                <td><a class="btn btn-dark"><?php echo $row["status_name"]; ?></a>
                                                </td>
                                                <?php } ?>
                                                <?php
